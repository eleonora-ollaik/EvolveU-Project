...
export const convertFormat = (serverData) => {
    ...
    return serverData.map((quizObj) => ({name: quizObj.quiz_name,  quizId: quizObj.quiz_id, theme: quizObj.theme_name, theme_id: quizObj.theme_id, user_id: quizObj.user_id, dateCreated: quizObj.quiz_creation}))
}
