...
class QuestionModel(db.Model):
    ...
    def __init__(self, quiz_id, question_category, question_type, question_statement, question_correct_entries, question_wrong_entries, question_creation=datetime.now(), question_update=datetime.now()):
    ...
    def query_all(cls):
        result = db.session.query(cls.question_id, cls.quiz_id, cls.question_category,
                                  cls.question_type, cls.question_statement,
        ...
        return [{"question_id": question.question_id, "quiz_id": question.quiz_id,
                 "question_category": question.question_category, "question_type": question.question_type,
